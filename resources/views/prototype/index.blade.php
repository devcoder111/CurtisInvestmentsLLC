                        ...
                        <div class="col-md-6">
                            ...
                            <form class="form-inline p-3" method="POST" action="{{ url('/prototype/create-users') }}">
                                ...
                                <div class="form-group mb-2 mr-2">
                                    ...
                                    <input type="text" class="form-control" id="add-users-input" name="qty" placeholder="Quantity" value="500">
                                </div>
                        ...
                        <div class="col-md-6">
                            <table class="table table-dark">
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        <td><a href="{{ url('prototype/users/' . $user->id) }}">{{ $user->first_name }} {{ $user->last_name }}</a></td>
