...
<body class="font-sans text-gray-600 bg-gray-200 leading-normal p-4 h-full">
    <div id="app" class="h-full md:flex md:justify-center md:items-center">
        <div class="w-full max-w-lg">
            ...
            <p class="flex items-center mb-4 bg-green-100 border border-green-200 px-5 py-4 rounded-lg text-green-700"
            ...
            <div class="bg-white rounded-lg shadow-xl p-4 sm:py-6 sm:px-10 mb-5">
                ...
                <div id="payment-elements" v-if="! paymentProcessed">
                    ...
                    <label for="cardholder-name"
                        class="inline-block text-sm text-gray-700 font-semibold mb-2">{{ __('Full name') }}</label>
                    ...
                    <label for="card-element"
                        class="inline-block text-sm text-gray-700 font-semibold mb-2">{{ __('Card') }}</label>
                    ...
                    <button id="card-button"
                        ...
                        @click="confirmPayment" :disabled="paymentProcessing">
        ...
        methods: {
            ...
            goBack: function() {
                ...
                if (self.successMessage || self.errorMessage) {
                    redirect.searchParams.append('message', self.successMessage ? self.successMessage : self
                        .errorMessage);
